package uk.prudentialwarnew.GooglePlace;
 ...
 */
public class GooglePlaceSample extends AppCompatActivity implements PlaceSelectionListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_googleplace);
